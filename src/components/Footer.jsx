        ...
        <div className="flex flex-col gap-10 items-center p-16">
            ...
            {!isSubmitted ? (
                <div className="flex flex-col gap-4 items-center">
                    ...
                    <div className="flex border mb-4">
                        <input type="email" name="email" value={data} onChange={(e) => setData(e.target.value)} placeholder="Email" className="outline-0 p-3 font-roboto bg-white w-[400px]"/>
            ...
            <div className="flex gap-4">
                {socials.map((social, index) => (
                    <a key={index} href={social.link}><img src={social.icon} alt="Social media icon." className="hover:animate-spin" /></a>
                ))}
            </div>
